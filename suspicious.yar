...
rule suspicious {
    ...
    strings:
        ...
        $inject8 = "InternetOpenUrlA" fullword ascii 
        $inject9 = "InjectorLib" fullword ascii 
        $inject10 = "VirtualProtectEx" nocase ascii wide
        $inject11 = "SuspendThread" nocase ascii wide
        $inject12 = "VirtualAllocEx" nocase ascii wide
